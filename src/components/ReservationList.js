...
import { Tabs, Tab, Box, Typography, Card, CardContent, CardActions, Button, Paper, Chip, Divider, CircularProgress } from '@mui/material';
...
const ReservationList = ({
  ...
  const handleOpenCommentDialog = (reservation) => {
    setSelectedReservation(reservation);
